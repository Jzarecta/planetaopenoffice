...
class Baseset(db.Model):
    title = db.StringProperty(multiline=False,default='Planeta OpenOffice')
    subtitle = db.StringProperty(multiline=False,default='Libera tu oficina y escritorio.')
    description = db.TextProperty(default='Sitio comunitario de OpenOffice en GAE.')
    ...
    admin_email = db.StringProperty(multiline=False,default='acolorado@gmail.com')
